...
from ...core.config.loader import generate_config_toml_from_app_model
import logging
...
def update_config(updates: dict):
    ...
    try:
        ...
        if ctx is not None:
            ...
            from ...core.config import ConfigLoader as _ConfigLoader
...
def get_config_options():
    ...
    return {
        ...
        "general": {
            "provider": ["animepahe", "anizone", "gogoanime"],
