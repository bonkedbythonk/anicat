class AnicatError(Exception):
    """
    Base exception for all custom errors raised by the Anicat library and application.
...
class AuthenticationError(AnicatError):
    """
...
class DependencyNotFoundError(AnicatError):
    """
...
class ProviderError(AnicatError):
    """
...
class DownloaderError(AnicatError):
    """
...
class InvalidEpisodeRangeError(AnicatError, ValueError):
    """
