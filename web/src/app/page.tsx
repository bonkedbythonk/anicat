...
export default function App() {
  ...
  if (activeUpdateOverlay && activeUpdateOverlay.active) {
    return (
      <div className="flex h-screen w-screen items-center justify-center bg-background text-foreground p-6 font-sans">
        <style>{`
        ...
        <div className="max-w-md w-full text-center space-y-6 animate-fade-in">
          ...
          <div className="w-48 mx-auto h-1.5 bg-surface border border-border rounded-full overflow-hidden">
  ...
  if (connectionStatus === "failed") {
    return (
      <div className="flex h-screen w-screen items-center justify-center bg-background text-foreground p-6 font-sans">
        <div className="max-w-md w-full bg-card border border-border backdrop-blur-xl rounded-3xl p-8 space-y-6 shadow-2xl shadow-black/80 animate-fade-in">
          ...
          <div className="p-4 rounded-2xl bg-surface border border-border space-y-3.5 text-xs">
            ...
            {connectionError && (
              <div className="pt-2 border-t border-border text-[10px] text-red-300/80 leading-relaxed font-mono whitespace-pre-wrap break-all">
    ...
    <div className="flex h-screen w-screen overflow-hidden relative">
      ...
      >
        ...
        <div className="sticky top-0 left-0 right-0 z-[200] h-0.5 bg-accent/0 transition-all duration-300"
          style={{ opacity: 'var(--pull-indicator-opacity, 0)' }}
        />
      ...
      <AnimatePresence>
        {appState.selectedItem && (
          <MediaDetail 
            ...
            onPlayEpisode={(episode, provider, server) => {
              appState.startPlayback(appState.selectedItem!, episode, provider, server);
            }}
