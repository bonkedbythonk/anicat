      ...
      <div className="flex items-center justify-between">
        ...
        {notifications.length > 0 && (
          <button 
            ...
            className="flex items-center space-x-2 px-4 py-2 bg-white/[0.04] hover:bg-accent hover:text-white border border-white/[0.06] rounded-xl text-sm font-bold transition-all disabled:opacity-50"
          >
