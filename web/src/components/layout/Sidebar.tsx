...
export default function Sidebar({ activeView, onNavigate, notificationCount = 0, health }: SidebarProps) {
  return (
    <aside className="fixed left-0 top-0 bottom-0 w-[72px] lg:w-60 glass border-r border-border z-50 flex flex-col py-6 transition-all duration-300">
      ...
      <div className="flex flex-col items-center justify-center px-4 mb-10 pt-2">
        ...
        <img
          src="/anicat_logo.png"
          alt="Anicat Logo"
          className="w-24 h-auto lg:w-32 opacity-95 hover:opacity-100 transition-opacity object-contain dark:invert-0 invert"
        />
